...
export async function GET(req: Request) {
    ...
    if (!code) {
        return NextResponse.redirect(`${origin}/nucleo/roosevelt/cto/web-builder?github_error=no_code`);
    }
    ...
    try {
        ...
        if (!accessToken) {
            ...
            return NextResponse.redirect(`${origin}/nucleo/roosevelt/cto/web-builder?github_error=token_failed`);
        }
        ...
        const redirectUrl = new URL(`${origin}/nucleo/roosevelt/cto/web-builder`);
        ...
        return NextResponse.redirect(`${origin}/nucleo/roosevelt/cto/web-builder?github_error=${encodeURIComponent(error.message)}`);
    }
}
