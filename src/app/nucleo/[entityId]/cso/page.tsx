...
const tools = [
    {
        ...
        description: 'Strategic planning and execution of global expansion projects.',
        icon: TrendingUp,
        path: '#',
    ...
    },
    {
        ...
        description: 'Deep dive into market trends, competitors, and new opportunities.',
        icon: Target,
        path: '#',
    ...
    },
    {
        ...
        description: 'Long-term corporate goals and milestone tracking.',
        icon: Zap,
        path: '#',
        ...
        <div className="min-h-screen bg-[#050505] text-white p-8 pt-24">
            <div className="max-w-6xl mx-auto">
                <header className="mb-12">
                    ...
                    >
                        <h6 className="text-yellow-500 uppercase tracking-widest text-xs font-medium mb-2">Strategy Office</h6>
                        <h1 className="text-4xl md:text-5xl font-medium bg-gradient-to-r from-white to-white/50 bg-clip-text text-transparent tracking-tight">CSO Office</h1>
                        <p className="text-white/40 mt-4 max-w-xl text-lg font-light">
                            Define the long-term vision and ensure every department scales towards our core mission.
                        </p>
                    </motion.div>
                </header>
