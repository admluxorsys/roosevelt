...
import { Megaphone, BarChart, Users, ArrowRight } from 'lucide-react';
        ...
        <div className="min-h-screen bg-[#050505] text-white p-8 pt-24">
            <div className="max-w-6xl mx-auto">
                <header className="mb-12">
                    ...
                    >
                        <h6 className="text-rose-500 uppercase tracking-widest text-xs font-medium mb-2">Growth Department</h6>
                        <h1 className="text-4xl md:text-5xl font-medium bg-gradient-to-r from-white to-white/50 bg-clip-text text-transparent tracking-tight">CMO Office</h1>
                        <p className="text-white/40 mt-4 max-w-xl text-lg font-light">
                            Fuel the company's growth engine through data-driven marketing and relentless sales execution.
                        </p>
                    </motion.div>
                </header>
